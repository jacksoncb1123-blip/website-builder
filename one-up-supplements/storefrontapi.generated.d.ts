...
export type CollectionNavQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CollectionNavQuery = {
  collections: {
...
> & {
  ...
  >;
  servingSize?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  directions?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  supplementFacts?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CollectionNav($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    collections(first: 8, sortKey: UPDATED_AT) {\n      nodes {\n        id\n        title\n        handle\n      }\n    }\n  }\n': {
    return: CollectionNavQuery;
    variables: CollectionNavQueryVariables;
  };
